...
      "Sterilisasi membantu mencegah reproduksi berlebih, menurunkan risiko kanker, serta meningkatkan perilaku dan kesehatan jangka panjang hewan.",
    // MODIFIKASI: `price` menjadi harga diskon, `originalPrice` adalah harga asli
    price: 250000,
...
    price: 100000, // Tanpa diskon, jadi tidak ada originalPrice
  },
...
          <p className="text-gray-700 mb-4">{layanan.desc}</p>
          ...
          {/* MODIFIKASI: Logika untuk menampilkan harga normal atau harga diskon */}
          <div className="mb-6">
            {layanan.originalPrice ? (
              // Tampilan jika ada harga diskon
              <div className="flex items-end gap-3">
                <p className="text-2xl font-bold text-purple-700">
                  {formatRupiah(layanan.price)}
                </p>
                <p className="text-md text-gray-500 line-through">
                  {formatRupiah(layanan.originalPrice)}
                </p>
              </div>
            ) : (
              // Tampilan jika harga normal
